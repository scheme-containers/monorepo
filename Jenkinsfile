pipeline {
    ...
    parameters {
        string(name: 'SCHEMES', defaultValue: 'biwascheme chezscheme cabyscheme chibi chicken cyclone gauche gambit gerbil guile ironscheme kawa lips loko meevax mit-scheme racket sagittarius scm skint stak stklos tr7', description: 'Build and deploy theses Schemes')
