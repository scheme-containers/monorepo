pipeline {
    ...
    parameters {
        string(name: 'SCHEMES', defaultValue: 'biwascheme chibi chicken cyclone gauche kawa lips loko meevax mit-scheme racket sagittarius scm stak stklos tr7', description: 'Build and deploy theses Schemes')
