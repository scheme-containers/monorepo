pipeline {
    ...
    parameters {
        string(name: 'SCHEMES', defaultValue: 'biwascheme capyscheme chibi cyclone gauche goldfish guile lips meevax scheme-rs skint stak steel stklos tr7', description: 'Build and deploy theses Schemes')
